      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6">
          <p>
            ...
            the App, including via the AIDYOR API, you acknowledge that you have read, understood, and
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4">8. API and Third-Party Integrations</h2>
            <p>
              This disclaimer applies equally to anyone who views or receives AIDyor's risk scores, flags,
              or analysis, whether directly through the App or indirectly through a third-party product,
              wallet, bot, exchange, or other service that integrates the AIDYOR API ("Integrating Business").
            </p>
            <p className="mt-2">
              An Integrating Business is responsible for ensuring that its own users understand AIDyor's
              output is informational only, is not financial advice, and does not guarantee that any token
              is safe. AIDyor is not a party to, and has no liability arising from, the relationship between
              an Integrating Business and that business's own users or customers.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4">9. Consult Professionals</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4">10. Changes to This Disclaimer</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have any questions about this disclaimer, please contact us through the app, or for
              API and business inquiries, at api@aidyor.app.
            </p>
          </section>
        </div>
